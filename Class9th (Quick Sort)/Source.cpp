...
int QuickSort(int list[], int start, int end)
{
	...
	while (left <= right)
	{
		// left가 end보다 작거나 같고 list[left]가 list[pivot]보다 작거나
		// 같을 때까지 반복합니다. 
		...
		// right가 start보다 크고 list[right]가 list[pivot]보다 크거나 
		// 같을 때까지 반복합니다. 
...
{
#pragma region 퀵 정렬
	// 기준점(pivot)을 획득한 다음 해당 기준점을 기준으로 배열을 나누고
	// 한 쪽에는 기준점보다 작은 값들이 위치하고 다른 한 쪽에는 기준점보다
	// 큰 값들이 위치하도록 정렬하는 알고리즘입니다. 
